...
export default {
  ...
  get: jest.fn(url => {
    ...
    const resolvePromise = { status: 200, statusText: "OK",  data: null };
    const rejectPromise  = { status: 500, statusText: "Err", data: null };
  
    switch (url) {
    
      case ("/api/days")        : resolvePromise.data = fixtures.days;         break;
